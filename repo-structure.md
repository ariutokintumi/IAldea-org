...
| `[docs/roles/excel-sheets.md](docs/roles/excel-sheets.md)` | Índice pestañas Excel ↔ CSV (regenerable con `scripts/export_role_model_excel.py`) |
