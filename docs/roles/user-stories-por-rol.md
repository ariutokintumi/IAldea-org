...
Generado desde la pestaña **UserStories por rol** del libro [Role Model + Permission Matrix - IAldea.xlsx](../Role%20Model%20+%20Permission%20Matrix%20-%20IAldea.xlsx) (export CSV en repo).

La columna **Rol** está repetida en cada fila para facilitar filtros e importaciones.

- **CSV:** [user-stories-por-rol.csv](user-stories-por-rol.csv)
- **Historias cortas del taller Día 2:** [user-stories.md](user-stories.md)
- **Preguntas UX por etapa:** [user-stories-matriz.md](user-stories-matriz.md)

Los roles **Admin técnico** y **Operador de Piloto** amplían el núcleo en [role-model.md](role-model.md).
